# Devops: JWT pizza service

[< Back Home](/..)

#### See the code

- [JWT Pizza frontend](https://github.com/chancecarr/jwt-pizza)
- [JWT Pizza backend](https://github.com/chancecarr/jwt-pizza-service)
...
- Bash scripting for automating build processes
- Github Actions & Github Pages
- Mocking with Jest
- Frontend testing with Playwright
- Cloud deployment tools- load balancers, AWS CloudFormation, S3
- Grafana metrics, logging, and alerts
- Pinpointing bugs using metrics & logging